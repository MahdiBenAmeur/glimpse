...
FACE_POST_MERGE_THRESHOLD = 0.30
FACE_QUALITY_REFERENCE_PIXELS = 4096
FACE_TOP_EXEMPLAR_COUNT = 10
FACE_FINAL_MERGE_CENTROID_THRESHOLD = 0.25
FACE_FINAL_MERGE_EXEMPLAR_THRESHOLD = 0.25
FACE_FINAL_MERGE_AVG_EXEMPLAR_THRESHOLD = 0.25
