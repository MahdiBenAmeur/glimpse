...
def read_folder(folder_id: str, session: Session = Depends(get_session)):
...
def update_folder(folder_id: str, folder_in: FolderUpdate, session: Session = Depends(get_session)):
